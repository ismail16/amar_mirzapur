...
<html lang="en">
  <head>
    ...
    <link href="<?php echo BASE;?>/files/assets/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    
    <link href="<?php echo BASE;?>/files/assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />

    <link href="<?php echo BASE;?>/files/assets/vendors/base/vendors.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo BASE;?>/files/assets/demo/default/base/style.bundle.css" rel="stylesheet" type="text/css" />
    <link rel="shortcut icon" href="<?php echo BASE;?>/files/assets/demo/default/media/img/logo/favicon.ico" />
